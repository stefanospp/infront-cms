...
async function seed() {
  ...
  await seedIfEmpty('faqs', [
    { question: 'What exam boards do you cover?', answer: [{ type: 'paragraph', children: [{ text: 'We cover Cambridge International (CIE), Pearson Edexcel, and IB Diploma Programme. Lessons are tailored to the specific syllabus and exam format of your board — including past paper practice with real mark schemes.' }] }], order: 1 },
    { question: 'Do you offer online lessons?', answer: [{ type: 'paragraph', children: [{ text: 'Yes. We offer both in-person lessons in Larnaca and online sessions via Zoom for students anywhere in Cyprus and across Europe.' }] }], order: 2 },
    { question: 'How are group revision courses structured?', answer: [{ type: 'paragraph', children: [{ text: 'Group courses run over 4–8 weeks with sessions 2–3 times per week. Classes are capped at 8–10 students to ensure everyone gets individual attention.' }] }], order: 3 },
    { question: 'What subjects do you teach?', answer: [{ type: 'paragraph', children: [{ text: 'We specialise in the three core sciences: Biology, Chemistry, and Physics. We cover these at IGCSE, AS, A-Level, and IB Higher/Standard Level.' }] }], order: 4 },
    { question: 'How do I prepare for the UCAT exam?', answer: [{ type: 'paragraph', children: [{ text: 'Our UCAT preparation covers all four sections — Verbal Reasoning, Decision Making, Quantitative Reasoning, and Situational Judgement. We offer intensive one-day workshops and ongoing weekly sessions from June through September.' }] }], order: 5 },
    { question: 'Do you help with IB Internal Assessments?', answer: [{ type: 'paragraph', children: [{ text: 'Yes. IB Internal Assessments carry significant weight in your final grade. We help with topic selection, experimental design, data analysis, and report writing — all aligned with IB assessment criteria.' }] }], order: 6 },
    { question: 'When should I start revision?', answer: [{ type: 'paragraph', children: [{ text: 'For May/June exams, serious revision should begin 8–10 weeks ahead — around late February or early March. We run Easter intensive courses specifically for this window. For mock exams in January, we recommend starting in November.' }] }], order: 7 },
    { question: 'Which schools do your students attend?', answer: [{ type: 'paragraph', children: [{ text: "Our students come from American Academy Larnaca, Pascal English School, Med High, The English School, Forum, and other private schools across Cyprus. Each student's lessons follow their own school's curriculum and exam board." }] }], order: 8 },
  ]);
